        ...
        <div class="wow bounceInUp">
            <div class="main">
                ...
                <div class="row sub">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="price" class="form-control" value= "${meal.price}" required>
                    </div>
                </div>
                <div class="row sub">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control" name="description" cols="10" rows="5" maxlength="200" value="${meal.description}" required>${meal.description}</textarea>
                    </div>
                </div>
                <div class="row sub">
                    <div class="col-md-6">
                ...
                ${result}
                <div class="row sub">
                    <input type="submit" name="" class="submit_button" value="Edit Meal">
                </div>
            </div>
         </div>
            </div>
